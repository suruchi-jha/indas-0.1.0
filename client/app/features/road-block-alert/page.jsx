...
export default function RoadBlockAlert() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white via-gray-100 to-gray-300">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        ...
        <h1 className="text-4xl font-bold mb-4 text-center">Road Block Alert</h1>
        ...
        <p className="text-center text-gray-600 max-w-2xl mb-8">
          We're working hard to bring you real-time road block alerts during emergencies. This feature will help you
          navigate safely by providing alternative routes and up-to-date information about road conditions.
        </p>
        <Link
          href="/"
