  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-white via-gray-100 to-gray-300">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        ...
        <h1 className="text-4xl font-bold mb-4 text-center">Community Help</h1>
        ...
        <p className="text-center text-gray-600 max-w-2xl mb-8">
          We're building a platform to connect those who need help with those who can provide it during emergencies.
          This feature will allow you to request assistance, offer your skills or resources, and coordinate community
          response efforts.
        </p>
        <Link
          href="/"
